			...
			<section className="drivers">
				<div className="drivers__container container">
					...
					<p className="drivers__text">
						...
						как видеокарты и сетевые адаптеры. Обновленные драйверы можно
						скачать с <br/>
                    ...
                    <span className="drivers__content--title">
						...
						<ol className="drivers__list">
							<li className="drivers__item">
								<span>Lan</span> драйвер необходим для обеспечения корректной работы сетевого
								адаптера компьютера.
							</li>
							<li className="drivers__item">
								<span>Chipset</span> устанавливать для поколений процессоров Ryzen 7, intel
								13 и выше
							</li>
							<li className="drivers__item">
								<span>Sound</span> (Если сломался звук, а также если нужно более чёткое
								звучание)
							</li>
							<li className="drivers__item">
								<span>GPU</span> (Устанавливать свежую версию драйвера, совместимую с вашей
								видеокартой)
							</li>
						</ol>
					</div>
