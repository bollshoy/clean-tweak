...
const Hero = () => {
	...
	useEffect(() => {
		...
		gsap.fromTo(
				textRef.current,
				{x: 200, opacity: 0},
				{x: 0, opacity: 1, duration: 1.5, delay: 0.7, ease: "power2.out"}
		);
				...
				<div className="hero__container">
					...
					<div className="hero__content">
						<div className="typing__effect">
							<Typewriter text="CleanTweaking" speed={100}
							            onTextUpdate={handleTextUpdate}/>
							<h1 className="hero__title">{typedText}</h1>
						</div>
						<p className="hero__text" ref={textRef}>
							Оптимизируйте свой компьютер с CleanTweaking!
							Мы <span>повысим FPS</span> и снизим
							задержки.<br/>
							Услуга <span>Ultimate Optimization</span> включает удаление
							ненужных файлов, обновление
							<br/> драйверов и настройку <span>для игр</span>. Если ваш
							компьютер тормозит, свяжитесь с
							нами для <span>улучшения производительности!</span>
						</p>
