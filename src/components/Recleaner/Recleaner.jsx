...
const Recleaner = () => {
	...
	const animationDownload = () => {
		if (!fileUrl) {
			alert("Ошибка: Ссылка на файл недоступна!");
			return;
		}
		setIsLoading(true);
		downloadFile();
					...
					{openModal && (
							...
							>
                                ...
                                О проекте <span>Recleaner</span> и пользовательское соглашение
									...
									<p className="recleaner__modal-text">
										Программа не работает на Windows <span>7/8/8.1</span>, поддержка только актуальных версий систем, Windows <span>10</span> и Windows <span>11</span>.
									</p>
									<p className="recleaner__modal-text">
										Перед тем как что-либо сделать, пожалуйста, читайте описания в программе.
									</p>
									<p className="recleaner__modal-text">
										Программа <span>абсолютно бесплатная</span>, скачать может <span>любой желающий</span>.
									</p>
									<p className="recleaner__modal-text">
										Отключите Windows Defender на время использования.
									</p>
									<p className="recleaner__modal-text">
										Мы <span>не несём ответственности</span> за ваши действия. <span>ЧИТАЙТЕ ТЕКСТ</span> перед использованием.
									</p>
								</motion.div>
							</motion.div>
					)}
