      ...
      <AnimatePresence>
        {openModal && (
          ...
          >
            ...
            >
              <button className="recleaner__modal-close" onClick={toggleModal}>
                ✖
              </button>
              ...
              <p className="recleaner__modal-text">
                Программа не работает на Windows <span>7/8/8.1</span>, поддержка
                только актуальных версий систем, Windows <span>10</span> и
                Windows <span>11</span>.
              </p>
              <p className="recleaner__modal-text">
              ...
              <p className="recleaner__modal-text">
                Программа <span>абсолютно бесплатная</span>, скачать может{" "}
                <span>любой желающий</span>.
              </p>
              <p className="recleaner__modal-text">
                Отключите Windows Defender на время использования.
              </p>
              <p className="recleaner__modal-text">
                Мы <span>не несём ответственности</span> за ваши действия.{" "}
                <span>ЧИТАЙТЕ ТЕКСТ</span> перед использованием.
              </p>
            </motion.div>
          </motion.div>
        )}
