    ...
    return (
        <section className='tabs' id={'tab'}>
            ...
            <p className="tabs__text">
                С тысячами успешно настроенных компьютеров и довольными клиентами мы знаем, как достичь максимальной <br/>
                производительности вашей системы. Не тратьте время на поиск устаревших методов в Интернете — доверьте <br/>
