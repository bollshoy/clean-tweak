    ...
    useEffect(() => {
        const progressInterval = setInterval(() => {
            setProgress((prevProgress) => {
                ...
                return prevProgress + 20; // Увеличение прогресса
            });
        }, 1000);
        ...
        <section className={'testimonial'}>
            <div className="testimonial__container container">
                <div className="testimonial__content">
                    <h2 className="testimonial__title">Отзывы людей, которые нам доверились</h2>
                    <div className="testimonial__content-content">
                        <div className="progress-bar">
                            <div className="progress" style={{ width: `${progress}%` }} />
                        </div>
                        <span className="testimonial__content-title">{reviews[currentReviewIndex].name}</span>
